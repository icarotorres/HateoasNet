...
namespace HateoasNet.Tests
{
    ...
    public class AbstractHateoasShould : IDisposable
    {
        private IHateoas<Dictionary<string, object>> _sut;
        ...
        public void Generate_NullRouteName_ThrowsArgumentNullException()
        {
            ...
            _sut = new DictionaryHateoas(new Hateoas(_mockHateoasContext.Object, _mockUrlHelper.Object, _mockActionDescriptorCollectionProvider.Object));
#elif NET472 || NET48
